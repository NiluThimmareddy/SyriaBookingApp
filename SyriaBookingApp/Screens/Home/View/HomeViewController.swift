...
class HomeViewController: BaseViewController, UIViewControllerTransitioningDelegate, RecentlyViewedProtocol, CalenderVCDelegate {
    ...
    @IBOutlet weak var whyBookAtSyriabookingButton: UIButton!
    @IBOutlet weak var embracingSyriaBookingLabel: UILabel!
    @IBOutlet weak var seamlessTravelExperiencesLabel: UILabel!
    @IBOutlet weak var verifiedHotelsLabel: UILabel!
    @IBOutlet weak var bestPricesLocalDealsLabel: UILabel!
    @IBOutlet weak var reserveNowPayLaterLabel: UILabel!
...
extension HomeViewController {
    ...
    @objc func updateTexts() {
        ...
        if lang == .english {
            ...
            // Add search hotel button with bold 20 font
            let searchHotelAttributes: [NSAttributedString.Key: Any] = [
                .font: UIFont.boldSystemFont(ofSize: 20),
                .foregroundColor: UIColor.white // Assuming white text on colored background
            ]
            let searchHotelAttributedTitle = NSAttributedString(string: "Search", attributes: searchHotelAttributes)
            searchHotelButton.setAttributedTitle(searchHotelAttributedTitle, for: .normal)
            
            // New labels for the why book section
            whyBookAtSyriabookingButton.setTitle("Why book at SyriaBooking?", for: .normal)
            embracingSyriaBookingLabel.text = "Embracing Syria with Every Booking"
            seamlessTravelExperiencesLabel.text = "Book with SyriaBooking for trusted stays, exclusive local deals, and seamless travel experiences across Syria."
            verifiedHotelsLabel.text = "Verified Hotels You Can Trust"
            bestPricesLocalDealsLabel.text = "Best Prices, Exclusive Local Deals"
            reserveNowPayLaterLabel.text = "Reserve now, Pay later"
            customerSupportLabel.text = "24/7 Customer Support"
            ...
            handPickedHotelsDescriptionLabel.text = "اختبر أرقى الإقامات مع فنادقنا المختارة بعناية، والتي تم اختيارها لراحتها الاستثنائية وخدماتها ومواقعها المميزة."
            ...
            // Add search hotel button with bold 20 font - Arabic
            let searchHotelAttributes: [NSAttributedString.Key: Any] = [
                .font: UIFont.boldSystemFont(ofSize: 20),
                .foregroundColor: UIColor.white // Assuming white text on colored background
            ]
            let searchHotelAttributedTitle = NSAttributedString(string: "بحث", attributes: searchHotelAttributes)
            searchHotelButton.setAttributedTitle(searchHotelAttributedTitle, for: .normal)
            
            // New labels for the why book section - Arabic translations
            whyBookAtSyriabookingButton.setTitle("لماذا تحجز في سيريا بوكينغ؟", for: .normal)
            embracingSyriaBookingLabel.text = "نحتضن سوريا مع كل حجز"
            seamlessTravelExperiencesLabel.text = "احجز مع سيريا بوكينغ لإقامات موثوقة، عروض محلية حصرية، وتجارب سفر سلسة في جميع أنحاء سوريا."
            verifiedHotelsLabel.text = "فنادق موثقة يمكنك الوثوق بها"
            bestPricesLocalDealsLabel.text = "أفضل الأسعار، عروض محلية حصرية"
            reserveNowPayLaterLabel.text = "احجز الآن، ادفع لاحقاً"
            customerSupportLabel.text = "دعم العملاء 24/7"
...
//    }
    ...
    private func setWhereAreYouGoingButtonWithTitleAndSubtitle() {
        ...
        titleParagraphStyle.alignment = lang == .english ? .left : .left
        titleParagraphStyle.lineSpacing = 4
        titleParagraphStyle.baseWritingDirection = lang == .english ? .leftToRight : .leftToRight
        ...
        subtitleParagraphStyle.alignment = lang == .english ? .left : .right
        subtitleParagraphStyle.lineSpacing = 4
        subtitleParagraphStyle.baseWritingDirection = lang == .english ? .leftToRight : .rightToLeft
